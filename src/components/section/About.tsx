export default function About() {
	return (
		<section
			className="container md:grid grid-cols-12 gap-[1.875rem] px-[1.25rem] py-[2.5rem] md:py-[4.5rem] "
			id="about">
			<div className="md:col-span-8 md:col-start-3 flex flex-col gap-[1.875rem]">
				<h2 className="font-medium text-[2rem] md:text-[2.5rem] leading-[1.2] md:leading-[48px] tracking-[-2.5px] text-[#999999]">
					I approach design with{" "}
					<span className="text-white font-light font-display tracking-normal text-shadow-[0px_0px_3px_rgba(255,255,255,0.5)] text-shadow-[#ffffff] ">
						empathy
					</span>
					, code with{" "}
					<span className="text-white font-light font-display tracking-normal text-shadow-[0px_0px_3px_rgba(255,255,255,0.5)] text-shadow-[#ffffff]">
